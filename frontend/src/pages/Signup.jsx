...
export default function Signup() {
  ...
  return (
    <div className="h-screen flex items-center justify-center mesh-bg p-2 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-brand-yellow/10 rounded-full mix-blend-screen filter blur-3xl animate-blob"></div>
      <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-brand-accent/10 rounded-full mix-blend-screen filter blur-3xl animate-blob animation-delay-2000"></div>
      <div className="absolute -bottom-8 right-1/2 w-96 h-96 bg-brand-success/10 rounded-full mix-blend-screen filter blur-3xl animate-blob animation-delay-4000"></div>
      ...
      >
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-slate-400 mt-2 font-medium">Join WorkHive to empower your team.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            ...
            className="w-full bg-brand-yellow text-slate-900 font-extrabold text-lg py-3 rounded-xl hover:bg-amber-400 transition-all shadow-xl shadow-brand-yellow/10 flex items-center justify-center group mt-2"
          >
        ...
        <p className="text-center mt-6 text-sm font-medium text-slate-400">
          Already have an account? <Link to="/login" className="text-white font-bold hover:text-brand-yellow transition-colors">Log in here</Link>
        </p>
      </motion.div>
    </div>
  );
